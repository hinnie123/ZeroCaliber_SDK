...
// BlueprintGeneratedClass Bipod_Decor.Bipod_Decor_C
// 0x0030 (0x0358 - 0x0328)
class ABipod_Decor_C : public AActor
{
public:
	class UStaticMeshComponent*                        StaticMesh4;                                              // 0x0328(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Bipod_Decor.Bipod_Decor_C");
		return ptr;
	}
