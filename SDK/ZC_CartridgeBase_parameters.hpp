...
struct ACartridgeBase_C_UserConstructionScript_Params
{
};

// Function CartridgeBase.CartridgeBase_C.ReceiveTick
struct ACartridgeBase_C_ReceiveTick_Params
{
	float*                                             DeltaSeconds;                                             // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function CartridgeBase.CartridgeBase_C.ReceiveHit
struct ACartridgeBase_C_ReceiveHit_Params
{
...
struct ACartridgeBase_C_ExecuteUbergraph_CartridgeBase_Params
{
