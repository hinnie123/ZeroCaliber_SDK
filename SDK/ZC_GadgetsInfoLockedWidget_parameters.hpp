...
struct UGadgetsInfoLockedWidget_C_Get_LockedBg_Visibility_Params
{
	ESlateVisibility                                   ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function GadgetsInfoLockedWidget.GadgetsInfoLockedWidget_C.Construct
struct UGadgetsInfoLockedWidget_C_Construct_Params
{
};

// Function GadgetsInfoLockedWidget.GadgetsInfoLockedWidget_C.Setup
struct UGadgetsInfoLockedWidget_C_Setup_Params
{
...
struct UGadgetsInfoLockedWidget_C_ExecuteUbergraph_GadgetsInfoLockedWidget_Params
{
