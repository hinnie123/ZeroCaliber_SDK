...
struct UJoiningNotificationWidget_C_FailedToJoin_Params
{
};

// Function JoiningNotificationWidget.JoiningNotificationWidget_C.PlayAnim
struct UJoiningNotificationWidget_C_PlayAnim_Params
{
};

// Function JoiningNotificationWidget.JoiningNotificationWidget_C.Construct
struct UJoiningNotificationWidget_C_Construct_Params
{
};
...
struct UJoiningNotificationWidget_C_BndEvt__BackButton_K2Node_ComponentBoundEvent_12_OnButtonReleasedEvent__DelegateSignature_Params
{
};

// Function JoiningNotificationWidget.JoiningNotificationWidget_C.ExecuteUbergraph_JoiningNotificationWidget
struct UJoiningNotificationWidget_C_ExecuteUbergraph_JoiningNotificationWidget_Params
{
	int                                                EntryPoint;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function JoiningNotificationWidget.JoiningNotificationWidget_C.CloseButtonPressed__DelegateSignature
struct UJoiningNotificationWidget_C_CloseButtonPressed__DelegateSignature_Params
{
};
