...
public:
	...
	struct FScriptMulticastDelegate                    CloseButtonPressed;                                       // 0x0218(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass NotificationWidget.NotificationWidget_C");
		return ptr;
	}


	void BndEvt__BackButton_K2Node_ComponentBoundEvent_2_OnButtonReleasedEvent__DelegateSignature();
	void ExecuteUbergraph_NotificationWidget(int EntryPoint);
