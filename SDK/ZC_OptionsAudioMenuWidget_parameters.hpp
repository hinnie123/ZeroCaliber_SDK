...
struct UOptionsAudioMenuWidget_C_BndEvt__BackButton_K2Node_ComponentBoundEvent_94_OnButtonReleasedEvent__DelegateSignature_Params
{
};

// Function OptionsAudioMenuWidget.OptionsAudioMenuWidget_C.PreConstruct
struct UOptionsAudioMenuWidget_C_PreConstruct_Params
{
	bool*                                              IsDesignTime;                                             // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function OptionsAudioMenuWidget.OptionsAudioMenuWidget_C.ExecuteUbergraph_OptionsAudioMenuWidget
struct UOptionsAudioMenuWidget_C_ExecuteUbergraph_OptionsAudioMenuWidget_Params
{
